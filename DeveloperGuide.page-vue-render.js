...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Allow more robust regex matching for names:")]),_v(" Currently, the names of a student can only contain alphanumeric characters and spaces. This limitation rejects names containing terms like “S/O” (Son of), which are commonly used in contexts such as in Singapore. To address this, we plan to implement more robust regex matching rules that will accept a wider variety of characters. This change will allow the application to accommodate culturally specific naming conventions, enhancing its usability in diverse environments.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Ensure timeslot’s start time is earlier than end time:")]),_v(" In the current implementation, there are no checks to ensure that a timeslot's start time is earlier than its end time. This oversight can lead to the entry of illogical timeslots, such as a start time of 5 PM and an end time of")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Mon, 15 Apr 2024, 21:26:02 GMT+8]")])])])}
}];
