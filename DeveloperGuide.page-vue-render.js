...
with(this){return _c('ul',[_c('li',[_v("are an attribute of every student")]),_v(" "),_c('li',[_v("can vary from student to student, both in quantity of grades stored and test scores")]),_v(" "),_c('li',[_v("of the form: [test name: grade] where\n"),_c('ul',[_c('li',[_v("test name is non empty")]),_v(" "),_c('li',[_v("the grade is a value from 0 to 100, representing the percentage gotten in the test rounded to the nearest whole number")])])]),_v(" "),_c('li',[_v("are an optional parameter")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("are an attribute of every student")]),_v(" "),_c('li',[_v("of the form: [DayOfWeek StartTime-EndTime] where\n"),_c('ul',[_c('li',[_v("The DayOfWeek is any day from Monday to Sunday.")]),_v(" "),_c('li',[_v("StartTime and EndTime include hours and optional minutes in 12-hour format")]),_v(" "),_c('li',[_v("Minutes, if included, should be separated from hours by a colon")]),_v(" "),_c('li',[_v("For example, 'Saturday 4pm-6pm', 'Tuesday 2:30pm-4:30pm'")])])]),_v(" "),_c('li',[_v("are an optional parameter")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"improved-edit-functionality"}},[_v("Improved Edit Functionality"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#improved-edit-functionality","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("Single-Parameter Editing: The enhanced edit command will allow users to edit one parameter at a time. For example, instead of wiping out all grade values and replacing them with a new set of grades, the user can now edit individual grades or classes separately.")]),_v(" "),_c('li',[_v("Retain Previous Values: When a user initiates an edit operation, the system will display the current value of the parameter being edited. This value will be shown in the text area, allowing users to modify it based on the existing data. This approach aligns with the assumption that edits typically involve minor adjustments or updates rather than complete replacements.")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Alternative 1 was batch editing, allowing users to modify multiple parameters simultaneously. However, this could lead to confusion and data conflicts, especially with complex data. It might also need extra validation for data consistency.")]),_v(" "),_c('li',[_v("Alternative 2 involved a confirmation prompt before editing, informing users of potential data replacement. While transparent, it doesn't solve the issue of preserving data during edits.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("2a. The list is empty.\n"),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_v("3a. The given keyword is invalid.\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. System requests for the correct index.")])]),_v(" "),_c('li',[_c('p',[_v("3a3. User enters new index.")]),_v(" "),_c('p',[_v("Steps 3a2-3a3 are repeated until the data entered are correct.")]),_v(" "),_c('p',[_v("Use case resumes from step 4.")])])])]),_v(" "),_c('li',[_v("3b. The given keyword is not found.\n"),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Sun, 14 Apr 2024, 21:37:59 GMT+8]")])])])}
}];
